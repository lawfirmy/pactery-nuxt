  ...
  <div class="max-w-7xl mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between mb-5">
      ...
      <button
        ...
        class="px-5 py-2.5 bg-brand-800 text-white rounded-xl hover:bg-brand-900 text-sm font-medium shadow-sm shadow-brand-800/20 flex items-center gap-2"
      >
        + 새 문서
      </button>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-3 sm:p-4 mb-5">
      <div class="flex flex-wrap gap-2 sm:gap-3">
        <input
          ...
          class="flex-1 min-w-[150px] px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-600 text-sm"
    ...
    <div v-if="selectedIds.length > 0" class="bg-brand-50 rounded-xl p-3 mb-4 flex items-center justify-between">
      ...
      <div class="flex gap-2">
        <button
          ...
          class="px-3 py-1.5 bg-brand-800 text-white rounded-xl text-sm hover:bg-brand-900 disabled:opacity-50"
        >
          ...
          >
            ...
            <td class="px-4 py-3" @click.stop>
              <button
                ...
                class="p-1.5 text-gray-400 hover:text-brand-700 hover:bg-brand-50 rounded transition"
                title="복제"
              >
      ...
      <div v-if="pagination && pagination.totalPages > 1" class="flex justify-center gap-2 p-4 border-t">
        <button
          ...
          :class="[
            ...
            p === page ? 'bg-brand-800 text-white' : 'bg-gray-100 hover:bg-gray-200',
          ]"
        >
          {{ p }}
        </button>
      ...
      <div class="bg-white rounded-t-2xl sm:rounded-xl shadow-xl p-6 w-full sm:max-w-md">
        ...
        <form @submit.prevent="createNewDocument" class="space-y-4">
          ...
          <div class="flex gap-3 pt-2">
            ...
            <button type="submit" class="flex-1 px-4 py-2.5 bg-brand-800 text-white rounded-xl hover:bg-brand-900 text-sm font-medium">
              생성
            </button>
          </div>
        </form>
