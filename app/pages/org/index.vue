  ...
  <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex items-center justify-between mb-8">
      ...
      <NuxtLink
        ...
        class="px-5 py-2.5 bg-brand-800 text-white rounded-xl hover:bg-brand-900 text-sm font-medium transition shadow-sm shadow-brand-800/20 flex items-center gap-2"
      >
    ...
    <div class="grid md:grid-cols-2 gap-6 mb-8">
      ...
      <div class="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-2 gap-3">
          <NuxtLink to="/org/documents" class="flex flex-col items-center gap-2 p-4 bg-gray-50 rounded-xl text-sm hover:bg-brand-50 hover:text-brand-800 text-gray-600 transition-colors group">
          ...
          <NuxtLink to="/org/templates" class="flex flex-col items-center gap-2 p-4 bg-gray-50 rounded-xl text-sm hover:bg-brand-50 hover:text-brand-800 text-gray-600 transition-colors group">
            <svg class="w-6 h-6 text-gray-400 group-hover:text-brand-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" /></svg>
            템플릿
          </NuxtLink>
          <NuxtLink to="/org/cases" class="flex flex-col items-center gap-2 p-4 bg-gray-50 rounded-xl text-sm hover:bg-brand-50 hover:text-brand-800 text-gray-600 transition-colors group">
          ...
          <NuxtLink to="/org/members" class="flex flex-col items-center gap-2 p-4 bg-gray-50 rounded-xl text-sm hover:bg-brand-50 hover:text-brand-800 text-gray-600 transition-colors group">
