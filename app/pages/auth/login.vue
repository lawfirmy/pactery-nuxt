<template>
  <div>
    <h2 class="text-2xl font-bold text-gray-900 mb-1">로그인</h2>
    <p class="text-sm text-gray-500 mb-8">Pactery 계정으로 로그인하세요.</p>

    <!-- Social Login -->
    <div class="space-y-3">
      <button
        @click="loginWithGoogle"
        class="w-full flex items-center justify-center gap-3 py-2.5 border border-gray-200 rounded-xl hover:bg-gray-50 transition font-medium text-sm text-gray-700"
      >
      ...
      <button
        ...
        class="w-full flex items-center justify-center gap-3 py-2.5 bg-[#FEE500] rounded-xl hover:brightness-95 transition font-medium text-sm text-gray-900"
      >
        <svg class="w-5 h-5" viewBox="0 0 24 24">
